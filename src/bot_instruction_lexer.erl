...
-module(bot_instruction_lexer).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("src/day_10/bot_instruction_lexer.xrl", 19).
...
-file("src/bot_instruction_lexer.erl", 288).
yystate() -> 36.
...
-file("src/day_10/bot_instruction_lexer.xrl", 11).
yyaction_8() ->
     skip_token .

-compile({inline,yyaction_9/0}).
-file("src/day_10/bot_instruction_lexer.xrl", 12).
yyaction_9() ->
     skip_token .

-compile({inline,yyaction_10/0}).
-file("src/day_10/bot_instruction_lexer.xrl", 13).
yyaction_10() ->
     skip_token .

-compile({inline,yyaction_11/0}).
-file("src/day_10/bot_instruction_lexer.xrl", 14).
yyaction_11() ->
     skip_token .

-compile({inline,yyaction_12/0}).
-file("src/day_10/bot_instruction_lexer.xrl", 15).
yyaction_12() ->
     skip_token .
