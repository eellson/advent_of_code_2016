...
-file("src/ip_lexer.xrl", 7).
yyaction_0(TokenLine) ->
     { token, { hype_begin, TokenLine } } .

-compile({inline,yyaction_1/1}).
-file("src/ip_lexer.xrl", 8).
yyaction_1(TokenLine) ->
     { token, { hype_end, TokenLine } } .

-compile({inline,yyaction_2/1}).
-file("src/ip_lexer.xrl", 9).
yyaction_2(TokenChars) ->
     { token, { chars, TokenChars } } .

-compile({inline,yyaction_3/1}).
-file("src/ip_lexer.xrl", 10).
yyaction_3(TokenChars) ->
     { token, { ip_end, TokenChars } } .
