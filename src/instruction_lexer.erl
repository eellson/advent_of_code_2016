...
-file("src/day_8/instruction_lexer.xrl", 17).
...
-file("src/instruction_lexer.erl", 284).
yystate() -> 23.
...
-file("src/day_8/instruction_lexer.xrl", 3).
yyaction_0(TokenLine) ->
     { token, { rect, TokenLine } } .

-compile({inline,yyaction_1/1}).
-file("src/day_8/instruction_lexer.xrl", 4).
yyaction_1(TokenLine) ->
     { token, { rot, TokenLine } } .

-compile({inline,yyaction_2/1}).
-file("src/day_8/instruction_lexer.xrl", 5).
yyaction_2(TokenLine) ->
     { token, { row, TokenLine } } .

-compile({inline,yyaction_3/1}).
-file("src/day_8/instruction_lexer.xrl", 6).
yyaction_3(TokenLine) ->
     { token, { col, TokenLine } } .

-compile({inline,yyaction_4/1}).
-file("src/day_8/instruction_lexer.xrl", 7).
yyaction_4(TokenChars) ->
     { token, { n, TokenChars } } .

-compile({inline,yyaction_5/1}).
-file("src/day_8/instruction_lexer.xrl", 8).
yyaction_5(TokenLine) ->
     { token, { '=', TokenLine } } .

-compile({inline,yyaction_6/1}).
-file("src/day_8/instruction_lexer.xrl", 9).
yyaction_6(TokenLine) ->
     { token, { x, TokenLine } } .

-compile({inline,yyaction_7/1}).
-file("src/day_8/instruction_lexer.xrl", 10).
yyaction_7(TokenLine) ->
     { token, { y, TokenLine } } .

-compile({inline,yyaction_8/1}).
-file("src/day_8/instruction_lexer.xrl", 11).
yyaction_8(TokenLine) ->
     { token, { inst_end, TokenLine } } .

-compile({inline,yyaction_9/0}).
-file("src/day_8/instruction_lexer.xrl", 12).
yyaction_9() ->
     skip_token .

-compile({inline,yyaction_10/0}).
-file("src/day_8/instruction_lexer.xrl", 13).
yyaction_10() ->
     skip_token .
